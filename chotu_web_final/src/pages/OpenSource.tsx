...
export default function OpenSource() {
    ...
    <>
      ...
      <section className="container mx-auto py-12">
        ...
        <p className="text-muted-foreground max-w-3xl">
          CHOTU is a 6‑DOF robotic arm similar in form to the myCobot 320. It runs on a single Chotu UART controller
          driving six Chotu servo motors. The end effector integrates a camera and a suction pump.
        </p>
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-6">
          <article className="p-6 rounded-lg border bg-card">
            ...
            <ul className="mt-3 list-disc pl-5 text-sm leading-7 text-muted-foreground">
              <li>6 × Chotu Servo Motors</li>
              <li>1 × Chotu UART Controller</li>
  ...
  Specs adapted from Elephant Robotics myCobot 320 and tailored for Chotu (Chotu UART controller, design differences).
